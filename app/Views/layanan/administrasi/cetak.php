...
<body>
    ...
    <div class="inti_surat">
        <?php if ($data_surat['jenis_surat'] == "Surat Keterangan Usaha") : ?>
            ...
            <p class="justify">Adalah benar yang namanya tersebut diatas memiliki usaha <?= $jenis['jenis_usaha']; ?> yang beralamat di <?= $data_surat['desa']; ?> Kecamatan <?= $data_surat['kecamatan']; ?> Kabupaten Minahasa.
            </p>
