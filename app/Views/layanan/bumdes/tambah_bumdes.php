...
<div id="layoutSidenav_content">
    ...
    <div class="container-fluid px-4 pt-3">
            <div class="card mb-4">
                ...
                <?php endif; ?>
                <div class="card-body">
                    <form action="/bumdes/proses_tambah_bumdes" method="POST" enctype="multipart/form-data">
                            <input type="hidden" class="form-control" id="id_kelola" name="id_kelola" value="<?= $id_kelola ?>">
                            <div class="row mb-3">
