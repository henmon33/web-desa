...
<div id="layoutSidenav_content">
    ...
    <div class="container-fluid px-4 py-4">
            <div class="card mb-4">
                ...
                <?php endif; ?>
                <div class="card-body">
                    <form action="/bumdes/proses_ubah_bumdes/<?= $bumdes['id']; ?>" method="POST" enctype="multipart/form-data" >
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control <?= ($validation->hasError('stok')) ? 'is-invalid' : ''; ?>" id="stok" name="stok" value="<?= old('stok', $bumdes['stok']); ?>">
