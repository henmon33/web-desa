                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($d['status'] == "DIAJUKAN") : ?>
                                            ...
                                            <a href="/admin/rincian_surat/<?= $d['id']; ?>">
                                        ...
                                        <?php if ($d['status'] == "DIPROSES") : ?>
                                            <a target="_blank" href="/admin/cetak/<?= $d['id']; ?>/<?= $d['nik']; ?>/<?= $d['jenis_surat']; ?>">
                                                <button type="button" class="btn btn-primary">
                                        ...
                                        <?php if ($d['status'] == "DICETAK") : ?>
                                            ...
                                            <a href="/admin/surat_selesai/<?= $d['id']; ?>">
                                                <button type="button" class="btn btn-primary">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (obj.id != '') {
                    ...
                    $("#inputjenis_surat").val(obj.jenis_surat);
